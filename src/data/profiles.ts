...
export const profiles: ProfileMeta[] = [
  ...
  { id: "Submissive", primaryDimension: "SUR", summary: "You may enjoy intentionally handing over some control within negotiated limits.", reflection: "Surrender can be active and chosen, with trust and boundaries doing essential work." },
  { id: "Switch", primaryDimension: "DIR", summary: "Both guiding and surrendering may appeal, depending on the person, scene, or moment.", reflection: "Switching does not have to be evenly split or look the same in every relationship." },
  { id: "Sensation Giver", primaryDimension: "IGV", summary: "Creating controlled intensity and responding closely to a partner may appeal to you.", reflection: "Attention, calibration, and consent are more informative than intensity alone." },
  { id: "Sensation Receiver", primaryDimension: "IRC", summary: "Receiving controlled intensity or a test of composure may hold appeal.", reflection: "Appeal does not erase limits; pacing and communication still shape the experience." },
  { id: "Rigger", primaryDimension: "RST", summary: "The precision, responsibility, and craft of restraint may be especially interesting.", reflection: "This profile describes an affinity, not technical competence or safety training." },
